...
100 FORMAT(3(f15.5,3x),i5)
    ...
    IF (SIZE(jj,1)==3) THEN
       DO m = 1, SIZE(jj, 2)
          ...
          n2 = jj(2, m)
          n3 = jj(3, m)
          WRITE (unit_w, *) rr(1,n1), rr(2,n1), uu(n1), n1
          WRITE (unit_w, *) rr(1,n2), rr(2,n2), uu(n2), n2
          WRITE (unit_w, *) rr(1,n3), rr(2,n3), uu(n3), n3
          WRITE (unit_w, *)
       ENDDO
...
100 FORMAT(2(e11.5,3x),i5,3x,i5)
  ...
  SUBROUTINE vtk_p1_2d(mesh, champ, unit_file, file_name)
    ...
    WRITE(*,*) 'points ...'
    DO i=1, mesh%np
       WRITE(unit_file,'(2(e13.7,2x),A)') mesh%rr(1,i), &
            mesh%rr(2,i), ' 0.0 '
    ENDDO
    WRITE(*,*) 'cells ...'
    ...
    DO i=1, mesh%np
       WRITE(unit_file,'(e13.7,2x)') champ(i)
    ENDDO
    CLOSE(unit_file)                                     
